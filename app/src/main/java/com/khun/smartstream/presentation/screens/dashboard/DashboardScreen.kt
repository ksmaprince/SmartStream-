...
import com.khun.smartstream.presentation.screens.Screens
import com.khun.smartstream.presentation.screens.categories.CategoriesScreen
import com.khun.smartstream.presentation.screens.home.HomeScreen
import com.khun.smartstream.presentation.screens.movies.MoviesScreen
import com.khun.smartstream.presentation.screens.profile.ProfileScreen
import com.khun.smartstream.presentation.screens.search.SearchScreen
import com.khun.smartstream.presentation.screens.shows.ShowsScreen
import com.khun.smartstream.presentation.utils.Padding
...
@Composable
fun DashboardScreen(
    openCategoryMovieList: (categoryId: Int) -> Unit,
    openMovieDetailsScreen: (movieId: Int) -> Unit,
    openTrailerVideoPlayer: (movieId: Int) -> Unit,
    ...
    BackPressHandledArea(
        ...
        Body(
            ...
            openTrailerPlayer = openTrailerVideoPlayer,
...
private fun Body(
    openCategoryMovieList: (categoryId: Int) -> Unit,
    openMovieDetailsScreen: (movieId: Int) -> Unit,
    openTrailerPlayer: (movieId: Int) -> Unit,
    openVideoPlayer: (Movie) -> Unit,
    ...
    NavHost(
        ...
        composable(Screens.Home()) {
            HomeScreen(
                ...
                goToTrailerVideoPlayer = openTrailerPlayer,
